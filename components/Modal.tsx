...
function Modal() {
    ...
    return (
        <MuiModal open={showModal} onClose={handleClose} className="fixed !top-[5vh] left-0 right-0 z-50 mx-auto w-full max-w-5xl overflow-hidden overflow-y-scroll rounded-md scrollbar-hide h-auto">
            <>
                ...
                <div className='relative pt-[56.25%]'>
                    <ReactPlayer
                        ...
                        muted={muted}
                    />
                    <div className='absolute flex w-full items-center justify-between px-10 bottom-10'>
